...
float heading, heading_m, pitch, roll, temperature, MPU_temp, resultantG ;
 ...
 */
  ...
  heading_m = atan2(magValue.x, magValue.y) * 180 / Pi;
  Serial.print(heading_m); 
  ...
  Serial.println("   |    MPU9250 temp: " + String(MPU_temp));
